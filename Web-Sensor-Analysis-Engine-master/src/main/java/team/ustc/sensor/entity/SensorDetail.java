...
public class SensorDetail {
    ...
    public SensorDetail(Map<String, Object> map) {
        ...
        this.companyId = Integer.valueOf(map.get("companyId").toString());
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sensorId, sensorName, companyId, companyName, sensorType, sensorTypeDetail, sensorInput, sensorOutput, sensorEnvironment, sensorRange, sensorLevel, sensorApplication, sensorDescription, sensorStrength, sensorOther, username);
    }
}
